...
public class CollectionElementDto extends FeedElementDto implements Serializable {
    ...
    public static CollectionElementDto fromCollectionResponse(CollectionElement collectionElement) {
    ...
    public FeedElement toCollectionResponse(CollectionElementDto feedElementDto) {
